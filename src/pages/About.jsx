    ...
    <div>
      ...
      <div className="aboutus-container">
        <div className="aboutus-user">
          ...
          <img
            src="https://media.licdn.com/dms/image/D4E03AQGDzk2z765akA/profile-displayphoto-shrink_800_800/0/1710354118843?e=1718841600&v=beta&t=cEr2gZvWKt3flIRh7Y_XG6MjykQJOel_sdeeGqxBkJE"
            className="profile"
          />
        ...
        <div className="aboutus-user">
          ...
          <p>{jamesText}</p>
          {/* <FlyingText text={jamesText} interval={20} />{" "} */}
          {/* You can adjust the interval as needed. The higher the slower */}
